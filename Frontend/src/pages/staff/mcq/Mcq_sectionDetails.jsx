...
const Mcq_sectionDetails = () => {
  ...
  >
    {/* 
      Remove the condition that depends on formData,
      or replace it with proper data source.
      If you're always showing this field, remove the condition entirely:
    */}
    <div className="flex items-center">
      <label className="text-md font-semibold text-[#111933] flex-1">Section Duration *</label>
      <input
        type="text"
        inputMode="numeric"
        pattern="[0-9]*"
