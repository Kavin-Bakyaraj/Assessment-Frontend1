...
import TestSection from './pages/staff/mcq/TestSection';
import QuestionSection from './pages/staff/mcq/QuestionSection';
import SectionAIgenerator from './pages/staff/mcq/SectionAIgenerator';
import SectionAIresponse from './pages/staff/mcq/SectionAIresponse';
import SectionManualUpload from './pages/staff/mcq/SectionManualUpload';
import SectionBulkupload from './pages/staff/mcq/SectionBulkupload';
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/mcq/section/questionLibrary" element={<QuestionSection />} />
        <Route path="/mcq/section/testLibrary" element={<TestSection />} />
        <Route path="/mcq/section/AIgenerator" element={<SectionAIgenerator />} />
        <Route path="/mcq/section/AIresponse" element={<SectionAIresponse />} />
        <Route path="/mcq/section/manual" element={<SectionManualUpload />}/>
        <Route path="mcq/section/bulkupload" element={<SectionBulkupload />}/>
