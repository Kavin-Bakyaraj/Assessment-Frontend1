...
import { cn } from "../../../src/lib/loaderutils";
        ...
        return (
          ...
          >
            <div>
              ...
              {index <= value && (
                <CheckFilled
                  className={cn("text-[#111933]", value === index && "text-[#ffcc00] opacity-100")}
                />
              )}
            </div>
            <span
              className={cn(
                "text-[#111933]",
                value === index && "text-[#111933] opacity-100"
              )}
            >
              {loadingState.text}
            </span>
    ...
    <AnimatePresence mode="wait">
      {loading && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="w-full h-full fixed inset-0 z-[10000] flex items-center justify-center backdrop-blur-2xl"
        >
