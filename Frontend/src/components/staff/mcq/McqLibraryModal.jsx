...
import QuestionLibraryIcon from "../../../assets/QuesLibraryNew.svg";
import TestLibraryIcon from "../../../assets/TestLibraryNew.svg";
      ...
      <div className="p-8 pb-12 max-w-4xl mx-auto bg-white rounded-lg shadow-lg relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div
            ...
            className="flex items-center p-6 bg-gray-50 rounded-lg text-center transform transition-all hover:-translate-y-2 hover:shadow-xl cursor-pointer border"
          >
            <img src={QuestionLibraryIcon} alt="Question Library" className="w-9 h-9 mr-4" />
            <div>
          ...
          <div
            ...
            className="flex items-center p-6 bg-gray-50 rounded-lg text-center border transform transition-all hover:-translate-y-2 hover:shadow-xl cursor-pointer"
          >
            <img src={TestLibraryIcon} alt="Test Library" className="w-9 h-9 mr-4" />
            <div>
