...
import { Search, Filter, ChevronRight, Loader2, X as CloseIcon } from 'lucide-react';
        ...
        {loading ? (
          ...
          <>
            {currentQuestions.map((question, index) => (
              ...
              >
                <div className="text-left text-sm font-medium text-[#111933] truncate w-8/12">
                  {question.question}
                </div>
                <div className="text-left text-sm text-[#111933] w-4/12">
    ...
    <div className="bg-white rounded-lg shadow-sm border">
      ...
      <div className="p-2">
        {filteredTests.map((test) => (
          ...
          >
            <h3 className="font-medium text-lg">{test.test_name}</h3>
          </div>
        ))}
      </div>
    </div>
