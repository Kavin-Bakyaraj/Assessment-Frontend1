...
>
  <Card className="p-6 sm:p-8 md:p-12 bg-transparent border-2 border-dashed rounded-2xl flex flex-col items-center justify-center text-center">
    <Plus className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-transparent rounded-full text-gray-500" />
    <h2 className="mt-4 text-base sm:text-lg md:text-xl text-gray-500">Create Your Test Here...</h2>
  </Card>
</motion.div>
